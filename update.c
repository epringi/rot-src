...
//void    who_html_update args( ( void ) ); // Removed because whoweb.c was causing issues and I don't care to have it for now
...
void update_handler( bool forced )
{
	...
	song_update();
	//who_html_update(); // Removed because whoweb.c was causing issues and I don't care to have it for now
    }
